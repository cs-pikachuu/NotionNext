...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '老一辈艺术家の自信与从容, 恭喜你又发现了好玩的🥳 , Welcome to PikachuのNotebook🎉',
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1623536995?spm_id_from=333.1007.0.0', // B站主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'PikachuのNoteBook', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
